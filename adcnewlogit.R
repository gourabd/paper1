...
affaddx0=nlm(part2afflh,b1,b00,(nsimaff0),(nsimunaff0),hessian=TRUE)
...
#res <- lapply(1:5000, function(i) try(simalgo(0.5,0.1,0.1,0.5,0.5,0.422,0.422,-0.266,-0.266,-0.411,-0.416), TRUE))
res <- lapply(1:5000, function(i) try(simalgo(0.5,0.1,0.3,0.2,0.5,0.422,0.2,-0.266,-0.333,-0.411,-0.416), TRUE))
...
write.table(V,"Vlogitmixed011")

write(c(abs(meanV[c(8)]+0.416)/0.416,varV[8],var2V[2],var2V[4],(lowerV[2]< -0.416 & upperV[2]>-0.416),(lowerV1[2]< -0.416 & upperV1[2]>-0.416),(lowerV2[2]< -0.416 & upperV2[2]>-0.416),mean(S1),mean(S2),mean(V[,17])),"adclogitmixed011",ncolumns=10)
write(c(abs(meanV[c(6)]+0.416)/0.416,varV[6],var2V[1],var2V[3],(lowerV[1]< -0.416 & upperV[1]>-0.416),(lowerV1[1]< -0.416 & upperV1[1]>-0.416),(lowerV2[1]< -0.416 & upperV2[1]>-0.416),mean(R1),mean(R2),mean(V[,17])),"adclogitmixed011",ncolumns=10,append=TRUE)

rm(res); rm(V); rm(meanV) ;rm(varV);rm(var2V);rm(R1);rm(R2);rm(S1);rm(S2)

#res <- lapply(1:5000, function(i) try(simalgo(0.0,0.1,0.1,0.5,0.5,0.422,0.422,-0.266,-0.266,-0.411,-0.416), TRUE))
res <- lapply(1:5000, function(i) try(simalgo(0,0.1,0.3,0.2,0.5,0.422,0.2,-0.266,-0.333,-0.411,-0.416), TRUE))
...
write.table(V,"Vlogitmixed010")

write(c(abs(meanV[c(8)]+0.416)/0.416,varV[8],var2V[2],var2V[4],(lowerV[2]< -0.416 & upperV[2]>-0.416),(lowerV1[2]< -0.416 & upperV1[2]>-0.416),(lowerV2[2]< -0.416 & upperV2[2]>-0.416),mean(S1),mean(S2),mean(V[,17])),"adclogitmixed010",ncolumns=10)
write(c(abs(meanV[c(6)]+0.416)/0.416,varV[6],var2V[1],var2V[3],(lowerV[1]< -0.416 & upperV[1]>-0.416),(lowerV1[1]< -0.416 & upperV1[1]>-0.416),(lowerV2[1]< -0.416 & upperV2[1]>-0.416),mean(R1),mean(R2),mean(V[,17])),"adclogitmixed010",ncolumns=10,append=TRUE)


#res <- lapply(1:5000, function(i) try(simalgo(1,0.1,0.1,0.5,0.5,0.422,0.422,-0.266,-0.266,-0.411,-0.416), TRUE))
res <- lapply(1:5000, function(i) try(simalgo(1,0.1,0.3,0.2,0.5,0.422,0.2,-0.266,-0.333,-0.411,-0.416), TRUE))
...
write.table(V,"Vlogitmixed012")

write(c(abs(meanV[c(8)]+0.416)/0.416,varV[8],var2V[2],var2V[4],(lowerV[2]< -0.416 & upperV[2]>-0.416),(lowerV1[2]< -0.416 & upperV1[2]>-0.416),(lowerV2[2]< -0.416 & upperV2[2]>-0.416),mean(S1),mean(S2),mean(V[,17])),"adclogitmixed012",ncolumns=10)
write(c(abs(meanV[c(6)]+0.416)/0.416,varV[6],var2V[1],var2V[3],(lowerV[1]< -0.416 & upperV[1]>-0.416),(lowerV1[1]< -0.416 & upperV1[1]>-0.416),(lowerV2[1]< -0.416 & upperV2[1]>-0.416),mean(R1),mean(R2),mean(V[,17])),"adclogitmixed012",ncolumns=10,append=TRUE)
